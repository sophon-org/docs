...
2. **Farming on Sophon Mainnet:** With the launch of Sophon Mainnet, all deposited assets will be transferred and made immediately accessible. New deposits and boosts will be available on Sophon Mainnet as well. The accumulated Sophon Points will then be used to calculate rewards in $SOPH tokens based on the allocated percentage of the token supply.
